...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-sky-500 text-white hover:bg-sky-400 shadow-sm hover:shadow-[0_0_16px_rgba(14,165,233,0.4)]",
        gold:
          "bg-amber-400 text-slate-900 hover:bg-amber-300 shadow-sm hover:shadow-[0_0_16px_rgba(251,191,36,0.4)] font-semibold",
        destructive:
